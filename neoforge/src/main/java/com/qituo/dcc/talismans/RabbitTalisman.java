...
public class RabbitTalisman extends TalismanBase {
    ...
    private void deactivateChickenRabbitPower(Player player) {
        ...
        // 根据游戏模式恢复 mayfly：创造/旁观保留原版飞行权，生存/冒险则关闭
        ...
        player.removeEffect(com.qituo.dcc.effects.TalismanEffects.CHICKEN_POWER);
    ...
    private void activateRabbitPower(Player player) {
        player.addEffect(new net.minecraft.world.effect.MobEffectInstance(
            com.qituo.dcc.effects.TalismanEffects.RABBIT_POWER,
            2 * 60 * 20,
            0,
            false,
            false,
    ...
    private void activateChickenRabbitPower(Player player) {
        ...
        player.addEffect(new net.minecraft.world.effect.MobEffectInstance(
            com.qituo.dcc.effects.TalismanEffects.CHICKEN_POWER,
            20 * 60 * 20,
            1,
            false,
            false,
